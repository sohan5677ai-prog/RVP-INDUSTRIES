...
export default function IrnEwbReport() {
  ...
  // Inward E-Way Bills (Purchases) State & Query
  const [inwardDate, setInwardDate] = useState(getTodayDdMmYyyy());
  const {
    data: inwardData,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
          <div className="text-xs text-muted-foreground font-medium">Compliance Sync</div>
          <div className="text-2xl font-bold mt-1 text-sky-600 flex items-center gap-1.5">
            <ShieldCheck className="h-6 w-6 text-sky-500" /> NIC Live
          </div>
          <div className="text-[11px] text-muted-foreground mt-0.5">TaxPro Sandbox / Production Ready</div>
        </div>
      </div>
        ...
        <TabsContent value="inward" className="space-y-4">
          <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="text-xs text-muted-foreground max-w-md">
              Fetches all E-Way Bills generated by outside suppliers/consignors with our GSTIN as consignee. You can reject incorrect bills within 72 hours.
            </div>
          </div>
          ...
          <div className="bg-card p-5 rounded-xl border border-border shadow-sm max-w-xl space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Verify any transporter ID (TRANSIN or GSTIN) directly with the GST/E-Way Bill national portal.
              </p>
            </div>
