            ...
            <div className="p-1">
              <table className="w-full text-[11px]">
                <tbody>
                  ...
                  <tr>
                    <td colSpan={2} className="py-1">Mode: <b>{transMode}</b><span className="ml-12">Approx Distance: <b>{dispatch.ewbDistance ? `${dispatch.ewbDistance} KM` : 'Auto-Calculated'}</b></span></td>
